...
export default function SelectTeamMembers({
    ...
    const handleDone = () => {
        if (selectedUsers.length === 0) {
            alert(t("please_select_at_least_one_user")); // Optional: show message
            return;
        }
    ...
    return (
        <Modal
            ...
            animationType="none"
            onRequestClose={() => {
                if (selectedUsers.length > 0) onClose();
            }}
        >
            <View style={styles.modalOverlay}>
                <View style={styles.modalContent}>
                    ...
                    <Pressable
                        ...
                        style={[
                            styles.doneButton,
                            selectedUsers.length === 0 && { backgroundColor: "#ccc" }
                        ]}
...
const styles = StyleSheet.create({
    modalOverlay: {
        ...
        backgroundColor: "#fff", borderTopLeftRadius: wp(7),
        borderTopRightRadius: wp(7), padding: wp(5), maxHeight: hp(85),
    }, headerRow: {
        flexDirection: "row",
        ...
        color: COLORS.primary, fontSize: wp(3.8),
        fontFamily: "Poppins_500Medium",
    },
    gridContainer: {
        flexDirection: "row", flexWrap: "wrap",
        justifyContent: "space-between", paddingBottom: hp(2),
    }, gridItem: {
        width: "48%",
        alignItems: "center", marginBottom: hp(2.5),
        backgroundColor: "#fafafa", paddingVertical: hp(2), borderRadius: wp(4),
    }, selectedCard: {
        backgroundColor: COLORS.primary + "15",
        borderWidth: hp(0.2), borderColor: COLORS.primary,
    }, checkbox: {
        position: "absolute",
        top: 8,
        right: 8,
    ...
    memberImage: {
        ...
        borderRadius: wp(7.5),
        marginBottom: hp(1), borderWidth: 1,
    },
    memberName: {
        fontSize: wp(3.1),
        fontFamily: "Poppins_500Medium", textAlign: "center",
        textTransform: "capitalize", paddingHorizontal: wp(1),
    },
    selectedText: {
